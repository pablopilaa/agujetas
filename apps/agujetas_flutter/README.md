...
- Seguimiento de peso corporal local-first con estado semanal visible, recordatorio diario automático al activar el toggle de Perfil y sync best-effort si hay backend disponible.
