...
- Editor local de rutinas: abrir una plantilla importada, modificar su lista de ejercicios/orden, guardar cambios o guardar una copia.
- Roles:
...
- Completar editor profundo de rutinas a nivel serie: editar defaults por plantilla sin mezclarlo con la sesion activa.
